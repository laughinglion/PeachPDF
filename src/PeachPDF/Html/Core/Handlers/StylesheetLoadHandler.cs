...
namespace PeachPDF.Html.Core.Handlers
{
    ...
    internal static class StylesheetLoadHandler
    {
        ...
        public static (string stylesheet, CssData stylesheetData) LoadStylesheet(HtmlContainerInt htmlContainer, string src, Dictionary<string, string> attributes)
        {
        ...
        private static string LoadStylesheet(HtmlContainerInt htmlContainer, string src)
        {
            ...
            throw new ArgumentOutOfRangeException(nameof(src),"only file uris are supported");
        }
